...
class Person{
    ...
    public void getInfo(){
        System.out.println("Меня зовут "+getName()+"\n"+
                           "Имя моей мамы: "+getMother().getName()+"\n"+
                           "Имя моего папы: "+getFather().getName()+"\n"+
                           "У меня две бабушки, бабушка "+getFather().getMother().getName()
                           +" и "+getMother().getMother().getName()+ "\n"+
                           " У меня два деда, деда "+getFather().getFather().getName()
                           +" и "+getMother().getFather().getName());
    }
}
